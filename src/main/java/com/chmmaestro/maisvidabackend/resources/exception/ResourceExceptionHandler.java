package com.chmmaestro.maisvidabackend.resources.exception;
...
public class ResourceExceptionHandler {
	...
	public ResponseEntity<StandardError> objjectNotFound(ObjectNotFounException e, HttpServletRequest request) {
